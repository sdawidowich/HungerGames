...
Event::Event(int tributes, std::string result, std::string statement, std::string tag) : num_involved_tributes(tributes), event_result(result), event_statement(statement), event_tag(tag) { }
...
void Event::change_event(int tributes, std::string result, std::string statement, std::string tag)
{
